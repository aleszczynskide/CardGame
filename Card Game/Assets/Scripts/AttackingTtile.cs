...
public class AttackingTtile : MonoBehaviour
{
    ...
    public void NextMove()
    {
        ...
        else if (GameManager.GetComponent<GameManager>().CurrentCardAttackRange == 0)
        {
            ...
            {
                if (GameManager.GetComponent<GameManager>().GameObjectCardsOnTheTable[CurrentCardX, CurrentCardY].GetComponent<CardCreator>().Move == true || GameManager.GetComponent<GameManager>().GameObjectCardsOnTheTable[CurrentCardX, CurrentCardY].GetComponent<CardCreator>().Push == true)
                {
                    Escape();
                }
                else
